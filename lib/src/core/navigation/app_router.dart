  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          path: '/academic-path',
          name: 'academic-path',
          builder: (context, state) => const AcademicPathScreen()),
      GoRoute(
      ...
      GoRoute(
          ...
          builder: (context, state) => const GenerationSelectionScreen()),
      GoRoute(
      ...
      GoRoute(
          path: '/senior-year',
          name: 'senior-year',
          builder: (context, state) => const SeniorYearScreen()),
      GoRoute(
          path: '/semester-selection',
          name: 'semester-selection',
          builder: (context, state) => const SemesterSelectionScreen()),
      GoRoute(
          path: '/university-stream-selection',
          name: 'university-stream-selection',
          builder: (context, state) => const UniversityStreamSelectionScreen()),
      GoRoute(
          path: '/university-track-selection',
          name: 'university-track-selection',
          builder: (context, state) => const UniversityTrackSelectionScreen()),
      ...
      GoRoute(
        ...
        name: 'quiz-result',
        builder: (context, state) =>
            QuizResultScreen(resultData: state.extra as Map<String, dynamic>?),
      ),
      GoRoute(
        path: '/exam',
        name: 'exam',
      ...
      GoRoute(
        ...
        name: 'exam-result',
        builder: (context, state) =>
            ExamResultScreen(resultData: state.extra as Map<String, dynamic>?),
      ),
      GoRoute(
        path: '/flashcard',
        name: 'flashcard',
      ...
      // ============================================================
      GoRoute(
          path: '/entrance/past-papers',
          name: 'entrance-past-papers',
          builder: (context, state) => const EntrancePastPapersScreen()),
      GoRoute(
        path: '/entrance/exam',
        name: 'entrance-exam',
        builder: (context, state) {
      ...
      GoRoute(
          path: '/entrance/schedule',
          name: 'entrance-schedule',
          builder: (context, state) => const EntranceScheduleScreen()),
      GoRoute(
          path: '/entrance/tips',
          name: 'entrance-tips',
          builder: (context, state) => const EntranceTipsScreen()),
      ...
      GoRoute(
          path: '/tutorial-video',
          name: 'tutorial-video',
          builder: (context, state) => const TutorialVideoScreen()),
      GoRoute(
          path: '/settings/about',
          name: 'about',
      ...
      GoRoute(
          ...
          builder: (context, state) => const NotificationCreationScreen()),
      GoRoute(
      ...
      GoRoute(
          ...
          builder: (context, state) =>
              const admin_settings.AdminAppSettingsScreen()),
      GoRoute(
          path: '/admin/entrance-management',
          name: 'entrance-management',
          builder: (context, state) => const EntranceManagementScreen()),
      GoRoute(
