            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: _buildStatCard(
                        'Unanswered', 
                        '$unanswered', 
                        '${total > 0 ? (unanswered / total * 100).toInt() : 0}%', 
                        Colors.orange, 
                        Icons.help_outline,
                      ),
                    ),
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      if (examTitle.isNotEmpty && examTitle != 'Exam') ...[
                        _buildDetailRow('Exam', examTitle),
                        const Divider(),
                      ],
              ...
              if (!passed && contentId.isNotEmpty)
                OutlinedButton.icon(
                  onPressed: () {
                    Navigator.pop(context); // Go back to exam
                  },
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Exam Champion: Successfully passed ${examTitle != 'Exam' ? examTitle : 'your exam'}',
